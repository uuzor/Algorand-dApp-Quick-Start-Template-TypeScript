...
export default function Founder() {
  ...
  return (
    <section id="founder" className="relative py-32 bg-gradient-to-b from-indigo-950 to-purple-950">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div
            className="inline-block px-4 py-2 bg-indigo-500/20 rounded-full text-indigo-300 text-sm font-semibold mb-4 border border-indigo-500/30"
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="relative h-96 md:h-auto">
              ...
              >
                ...
                <div className="w-64 h-64 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white text-8xl font-bold shadow-2xl">
                  TK
                </div>
              </motion.div>
            ...
            <div className="p-12 flex flex-col justify-center">
              ...
              >
                ...
                <p className="text-xl text-purple-400 mb-6">Founder & Lead Developer</p>

                <div className="w-16 h-1 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full mb-6" />
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Make DeFi automation accessible to everyone through decentralized, trustless infrastructure</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Build the most reliable and cost-effective automation protocol on Algorand</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Decentralization, security, transparency, and user empowerment</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4 mt-8">
                  <motion.a
                    ...
                    className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors border border-white/10"
